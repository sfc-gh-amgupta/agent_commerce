/*
================================================================================
HORIZON CATALOG - XCLOUD DATA SHARING w/ LISTINGS - NEEDED IF WANT TO EXPLICITLY SHOW X-CLOUD
================================================================================
...
-- ============================================================================
-- SECTION 9: SHARE SEMANTIC VIEW IN DATA PRODUCT
-- ============================================================================
-- Grant access to semantic views in the Finance data share
-- This makes the Finance data product AI-ready for consumers
-- ============================================================================
GRANT SELECT ON ALL SEMANTIC VIEWS IN SCHEMA finance_db.snow_data TO SHARE finance_data_share;

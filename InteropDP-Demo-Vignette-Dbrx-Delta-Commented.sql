/* ===================================================================
 * SNOWFLAKE-DATABRICKS INTEROPERABILITY DEMO
 * 
 * This script demonstrates end-to-end data interoperability between 
 ...
 * - Implementing cross-platform governance with projection policies
 * - Publishing data products through Snowflake Organization Listings on Internal Marketplace
 * 
 * Author: Amit Gupta
 * Last Updated: 2024
 * =================================================================== */
 ...
 * Delta tables stored in S3 from Databricks Unity Catalog.
 * 
...
-- This command shows the Snowflake IAM user that needs to be trusted by the AWS role
...
-- Test with account admin role (should show FAIL when trying to project salary)
use role accountadmin;
-- Project salary column - should FAIL due to projection policy
 ...
 * 2. Cross-platform governance with projection policies protecting PII
